...
const styles = StyleSheet.create({
  ...
  summaryCard: { flex: 1, backgroundColor: colors.cardBg, borderRadius: 16, padding: spacing.md, alignItems: 'center' },
  section: { marginBottom: spacing.lg },
  heatTable: { backgroundColor: colors.cardBg, borderRadius: 16, overflow: 'hidden' },
  ...
  dueRow: { flexDirection: 'row', backgroundColor: colors.cardBg, borderRadius: 12, padding: spacing.md, marginBottom: spacing.xs, alignItems: 'center' },
  riskRow: { flexDirection: 'row', backgroundColor: colors.cardBg, borderRadius: 12, padding: spacing.md, marginBottom: spacing.xs, alignItems: 'center', borderLeftWidth: 3, borderLeftColor: colors.status.weakArea },
});
