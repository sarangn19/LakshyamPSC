...
const PREREQUISITES: Record<string, string[]> = {
  ...
  'Arrival of Europeans & Early Resistance': ['Ancient Kerala', 'Medieval Kerala'],
  'Cultural History': ['Ancient Kerala', 'Medieval Kerala', 'Modern Kerala'],
  'Temple Entry Movement': ['Social Reform Movements'],
  'Major Agitations & Structural Protests': ['Social Reform Movements', 'Temple Entry Movement'],
  'Literary Renaissance': ['Social Reform Movements'],
  'Directive Principles & Fundamental Duties': ['Fundamental Rights'],
  'Union Executive': ['Constitutional Framework', 'Fundamental Rights'],
  'Union Legislature': ['Union Executive'],
  'Judiciary': ['Union Executive'],
  'State Executive & Legislature': ['Union Executive'],
  'Federal System & Local Government': ['State Executive & Legislature'],
  'Constitutional Bodies': ['Union Executive', 'Judiciary'],
  'Physiography of India': ['Physical Geography (World)'],
  'Geophysical Phenomena': ['Physical Geography (World)'],
  'Indian River Systems': ['Physiography of India'],
  'Climate of India': ['Physiography of India'],
  'Kerala Geography': ['Physical Geography (World)'],
  'Physics — Light, Sound, Heat & Electronics': ['Physics — Mechanics & Properties of Matter'],
  'Chemistry — Acids, Bases & Chemical Reactions': ['Chemistry — Atomic Structure & Periodicity'],
  'Biology — Biochemistry, Nutrition & Diseases': ['Biology — Human Physiology'],
  'Biology — Plant Physiology & Ecology': ['Biology — Human Physiology'],
  'Environmental Science & Waste Management': ['Biology — Human Physiology', 'Chemistry — Atomic Structure & Periodicity'],
  'Arithmetic': ['Number System & Basic Operations'],
  'Time, Speed, Distance & Work': ['Arithmetic'],
  'Mensuration': ['Arithmetic'],
  'Algebra & Progressions': ['Number System & Basic Operations'],
  'Data Interpretation': ['Arithmetic'],
  'Analogy & Classification': ['Series & Patterns'],
  'Coding & Decoding': ['Analogy & Classification'],
  'Direction Sense': ['Blood Relations & Direction Sense'],
  'Syllogisms & Venn Diagrams': ['Analogy & Classification'],
  'Prose & Drama (ഗദ്യവും നാടകവും)': ['Poetry (കവിത)'],
  'Medieval India': ['Ancient India'],
  'British Rule & Early Struggles': ['Medieval India'],
  'Indian National Movement': ['British Rule & Early Struggles'],
  'World Wars & International Alliances': ['Great Revolutions'],
  'Digital Governance & E-Governance': ['Bureaucracy & Administrative Machinery'],
  'Social Welfare & Public Policy': ['Bureaucracy & Administrative Machinery'],
  'Banking & Monetary Policy': ['National Income & Macroeconomic Indicators'],
  'Public Finance & Fiscal System': ['National Income & Macroeconomic Indicators'],
  'Sectors of Indian Economy': ['National Income & Macroeconomic Indicators'],
  'Planning & Development': ['Sectors of Indian Economy'],
  'Kerala Model of Development': ['Indian Economy'],
  'Socio-Economic Safety Networks': ['Kerala Model of Development'],
  'Kerala Fiscal & Industrial Landscape': ['Kerala Model of Development'],
  'Software & Operating Systems': ['Computer Hardware & Architecture'],
  'Web Technologies & Languages': ['Networks & Internet'],
  'Cyber Security & Threats': ['Networks & Internet'],
  'IT Act & Legal Frameworks': ['Cyber Security & Threats'],
  'Vocabulary': ['Grammar'],
  'Reading Comprehension & Writing': ['Vocabulary'],
  'Folk & Traditional Arts': ['Classical & Ritualistic Art Forms'],
  'Gender & Child Welfare': ['Human Rights & Civil Rights'],
  'Transparency & Anti-Corruption': ['Human Rights & Civil Rights'],
};
